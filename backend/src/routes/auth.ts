  ...
  try {
    ...
    res.json({
      user: {
        ...
        profile: user.profile ? { ...user.profile, skills: JSON.parse(user.profile.skills || '[]'), languages: JSON.parse(user.profile.languages || '[]') } : null,
      },
      token,
    ...
    try {
      ...
      res.json({
        ...
        user: {
          ...
          profile: updatedUser.profile ? { ...updatedUser.profile, skills: JSON.parse(updatedUser.profile.skills || '[]'), languages: JSON.parse(updatedUser.profile.languages || '[]') } : null,
        },
        token,
      });
    } catch (error) {
